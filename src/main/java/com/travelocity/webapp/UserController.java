...
public class UserController {
	...
	public String main(HttpSession ses) {
	...
	public String editProfile(@RequestParam String first_name, @RequestParam String last_name, @RequestParam String company,
			@RequestParam Long phone, @RequestParam String email, @RequestParam String password) {
